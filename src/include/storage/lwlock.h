...
#define PREDICATEWRITELOCK_MANAGER_LWLOCK_OFFSET \
	(PREDICATELOCK_MANAGER_LWLOCK_OFFSET + NUM_LOCK_PARTITIONS)
#define NUM_FIXED_LWLOCKS \
	(PREDICATEWRITELOCK_MANAGER_LWLOCK_OFFSET + NUM_PREDICATELOCK_PARTITIONS)
